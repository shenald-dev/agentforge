...
Alignment / Deferred:
Deferred major upgrades. Safely bumped minor/patch dependencies (`@langchain/core` 1.1.44 -> 1.1.45, `@types/node` 20.19.39 -> 20.19.40). Committing lifecycle release tag and logging the update.
